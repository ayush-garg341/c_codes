// By using private inheritance, the private data members and member functions of the base class are not accessible in the derived class and in main.
// Protected and Public members of the base class are accessible to the derived class but not in main.
...
int main(){
  ...
  car.car_details();
  //car.print_details();   // public functions of base class are not accessible in main
}
